namespace Mayreni
{
    ...
    public class yeghishe3 : System.Windows.Window, IComponentConnector
    {
        private bool _contentLoaded;
        internal Grid LayoutRoot;
        internal MediaElement media;
        internal yeghishe3 Window;
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/yeghishe3.xaml", UriKind.Relative);
