namespace Mayreni
{
    ...
    public class ghazaros3 : System.Windows.Window, IComponentConnector
    {
        private bool _contentLoaded;
        internal Grid LayoutRoot;
        internal MediaElement media;
        internal ghazaros3 Window;
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/ghazaros3.xaml", UriKind.Relative);
