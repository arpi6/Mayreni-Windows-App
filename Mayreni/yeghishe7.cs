namespace Mayreni
{
    ...
    public class yeghishe7 : System.Windows.Window, IComponentConnector
    {
        private bool _contentLoaded;
        internal MediaElement media;
        internal TextBlock txt4;
        internal yeghishe7 Window;
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/yeghishe7.xaml", UriKind.Relative);
        ...
        void IComponentConnector.Connect(int connectionId, object target)
        {
            ...
            {
                case 1:
                    this.Window = (yeghishe7) target;
                    break;

                case 2:
                    this.txt4 = (TextBlock) target;
                    break;
