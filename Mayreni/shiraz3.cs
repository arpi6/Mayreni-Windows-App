namespace Mayreni
{
    ...
    public class shiraz3 : System.Windows.Window, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/shiraz3.xaml", UriKind.Relative);
