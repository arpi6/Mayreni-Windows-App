namespace Mayreni
{
    ...
    public class writer : System.Windows.Window, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/writer.xaml", UriKind.Relative);
