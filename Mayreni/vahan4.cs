namespace Mayreni
{
    ...
    public class vahan4 : System.Windows.Window, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            if (!this._contentLoaded)
            {
                ...
                Uri resourceLocator = new Uri("/Mayreni;component/vahan4.xaml", UriKind.Relative);
